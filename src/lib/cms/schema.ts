...
export const COLLECTIONS: CollectionDef[] = [
  ...
  },
  {
    ...
    seed: [
      { group: "Hội đồng Quản trị", role: "Trưởng nhóm", name: "Ông Nguyễn Ngọc Hài", name_en: "Mr. Nguyen Ngoc Hai", title: "Chủ tịch Hội đồng Quản trị", title_en: "Chairman of the Board of Directors", photo: "/images/leadership/hdqt-chu-tich-nguyen-ngoc-hai.png" },
      { group: "Hội đồng Quản trị", role: "Thành viên", name: "Ông Đỗ Xuân Bình", name_en: "Mr. Do Xuan Binh", title: "Thành viên HĐQT", title_en: "Board Member", photo: "/images/leadership/hdqt-uv-do-xuan-binh.jpg" },
      { group: "Hội đồng Quản trị", role: "Thành viên", name: "Ông Lê Quang Hào", name_en: "Mr. Le Quang Hao", title: "Thành viên HĐQT", title_en: "Board Member", photo: "/images/leadership/hdqt-uv-le-quang-hao.jpg" },
      { group: "Ban Giám đốc", role: "Trưởng nhóm", name: "Ông Đỗ Xuân Bình", name_en: "Mr. Do Xuan Binh", title: "Giám đốc", title_en: "Director", photo: "/images/leadership/bgd-giam-doc-do-xuan-binh.jpg" },
      { group: "Ban Giám đốc", role: "Thành viên", name: "Ông Lê Năng", name_en: "Mr. Le Nang", title: "Phó Giám đốc", title_en: "Deputy Director", photo: "/images/leadership/bgd-pgd-le-nang.jpg" },
      { group: "Ban Giám đốc", role: "Thành viên", name: "Ông Nguyễn Xuân Hải", name_en: "Mr. Nguyen Xuan Hai", title: "Phó Giám đốc", title_en: "Deputy Director", photo: "/images/leadership/bgd-pgd-nguyen-xuan-hai.png" },
      { group: "Ban Giám đốc", role: "Thành viên", name: "Ông Nguyễn Đình Tới", name_en: "Mr. Nguyen Dinh Toi", title: "Kế toán trưởng", title_en: "Chief Accountant", photo: "/images/leadership/bgd-ktt-nguyen-dinh-toi.jpg" },
      { group: "Ban kiểm soát", role: "Trưởng nhóm", name: "Ông Nguyễn Thanh Khiết", name_en: "Mr. Nguyen Thanh Khiet", title: "Trưởng Ban kiểm soát", title_en: "Head of the Supervisory Board", photo: "/images/leadership/bks-truong-nguyen-thanh-khiet.jpg" },
      { group: "Ban kiểm soát", role: "Thành viên", name: "Ông Nguyễn Trung Tuấn", name_en: "Mr. Nguyen Trung Tuan", title: "Thành viên Ban Kiểm soát", title_en: "Supervisor", photo: "/images/leadership/bks-tv-nguyen-trung-tuan.jpg" },
      { group: "Ban kiểm soát", role: "Thành viên", name: "Bà Ngô Thị Hồng Hạnh", name_en: "Mrs. Ngo Thi Hong Hanh", title: "Thành viên Ban Kiểm soát", title_en: "Supervisor", photo: "/images/leadership/bks-tv-ngo-thi-hong-hanh.png" },
    ],
  },
  {
