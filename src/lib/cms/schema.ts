    ...
    seed: [
      {
        ...
        closing_content:
          "<p>Công ty hiện có 4 phòng ban và 1 phân xưởng vận hành sửa chữa. Nhà máy thủy điện Đakđrinh duy trì sản lượng điện bình quân hằng năm gần 540,925 triệu kWh. Công ty có kế hoạch niêm yết hơn 116 triệu cổ phiếu lên sàn chứng khoán, hướng tới trở thành công ty đại chúng trong lĩnh vực đầu tư, xây dựng, sản xuất kinh doanh điện năng.</p><p>Hai tổ máy của Nhà máy thủy điện Đakđrinh vận hành ổn định dưới sự chỉ đạo, điều hành sát sao của Ban lãnh đạo, đồng bộ từ quản lý sản xuất, kỹ thuật đến chào giá cạnh tranh trên thị trường điện, cùng hệ thống quản lý theo tiêu chuẩn ISO 9001-2008.</p>",
        closing_content_en:
          "<p>The Company currently has 4 departments and 1 operations and maintenance workshop. Dakdrinh Hydropower Plant maintains an average annual output of nearly 540.925 million kWh. The Company plans to list more than 116 million shares on the stock exchange, aiming to become a public company in power investment, construction, generation and trading.</p><p>Both units of Dakdrinh Hydropower Plant operate stably under the close direction of the Company's leadership, with coordinated production management, technical operations and competitive bidding on the power market, supported by an ISO 9001-2008 management system.</p>",
      },
    ],
  },
  {
